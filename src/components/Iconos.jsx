export function IconoInstagram({ className = 'w-5 h-5' }) {
  return (
...
export function IconoWhatsapp({ className = 'w-5 h-5' }) {
  return (
    <svg viewBox="0 0 32 32" width="26" height="26" fill="#25D366" className={className} aria-hidden="true">
